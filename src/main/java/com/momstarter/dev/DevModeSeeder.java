 ...
 * (i.e. local profile). At startup it idempotently ensures {@value #DEV_EMAIL}
 * exists in the database with {@code email_verified=true} so testers can log in
 * immediately without going through registration or email verification.
 *
 * <p>Security notes:
 * <ul>
 *   <li>Never active in production (DevModeGuard refuses startup if misconfigured).</li>
